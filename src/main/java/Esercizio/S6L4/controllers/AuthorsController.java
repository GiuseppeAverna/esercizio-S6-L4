package Esercizio.S6L4.controllers;
...
import Esercizio.S6L4.services.AuthorsService;
...
public class AuthorsController {
    ...
    public Author saveAuthor(@RequestBody @Validated NewAuthorDTO body, BindingResult validation) throws Exception {
